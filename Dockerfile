...
RUN apk add --no-cache libxslt-dev libxml2-dev python-dev nodejs npm pngquant pngcrush optipng gcc make libc-dev zlib zlib-dev bash-completion g++ pkgconfig autoconf automake libtool nasm build-base zlib-dev && \
